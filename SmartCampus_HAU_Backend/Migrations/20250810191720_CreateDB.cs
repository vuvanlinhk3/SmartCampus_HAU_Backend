        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    room_type = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Bookings_Periods_1_12", "[periods] >= 1 AND [periods] <= 12");
                    table.CheckConstraint("CK_Bookings_StartPeriod_1_12", "[start_period] >= 1 AND [start_period] <= 12");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_room_devices", x => x.room_device_id);
                    table.CheckConstraint("CK_RoomDevices_Quantity_NonNegative", "[quantity] >= 0");
                    table.ForeignKey(
                        name: "FK_room_devices_rooms_room_id",
                        column: x => x.room_id,
                        principalTable: "rooms",
                        principalColumn: "room_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    room_id = table.Column<int>(type: "int", nullable: false),
                    device_type = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    unit_label = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    device_code = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    status = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    detail = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_room_devices_room_id",
                table: "room_devices",
                column: "room_id");

            migrationBuilder.CreateIndex(
                name: "IX_rooms_room_name",
                table: "rooms",
                column: "room_name",
                unique: true);
